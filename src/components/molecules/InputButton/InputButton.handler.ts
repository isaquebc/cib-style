...
export interface InputButtonHandlers {
  // Input handlers
  ...
  // Button handler
  handleButtonClick?: (value: string, event: MouseEvent<HTMLButtonElement>) => void;
}
...
export const handleButtonClick = (
  ...
  callback?: (value: string, event: MouseEvent<HTMLButtonElement>) => void
): void => {
  if (callback) {
    callback(value, event);
  }
